      ...
      <>
        <div className='bgImage h-screen w-full relative'>
          ...
          <div className='overlay flex flex-col justify-between h-full'>
            ...
            <div className='flex pl-5 lg:pl-16 lg:pr-16 pt-5 w-full justify-between'>
              <div className='flex items-center gap-5'>
                <img src={logo} alt='RamenHouseLogo' className='w-24 h-25 cursor-pointer'/>
                <p className='text-white font-bold text-xl pt-2 hover:opacity-50 cursor-pointer'>RAMEN HOUSE SHINCHAN</p>
              </div>
              <div className='hidden lg:flex text-white font-bold text-xl gap-16'>
                <p className='hover:opacity-50 cursor-pointer'>PALATINE</p>
                <p className='hover:opacity-50 cursor-pointer'>GLENVIEW</p>
                <p className='hover:opacity-50 cursor-pointer'>VERNON HILLS</p>
              </div>
            </div>

            <div className='text-white px-5 lg:px-16 pb-10'>
              <p className='text-2xl lg:text-5xl'>YOUR FAVORITE JAPANESE FOOD <br/> PLACE IN TOWN.</p>
              <div className='bg-[#C74200] w-full lg:w-44 py-4 mt-2 lg:mt-10 cursor-pointer rounded-2xl text-center hover:text-black hover:bg-white transition-colors'>
                <p>Choose location</p>
              </div>
            </div>
          ...
          <div className='flex flex-col lg:flex-row mt-10 md:pl-16'>
            ...
            <div className='lg:w-1/2 flex flex-col items-center px-4 lg:px-16'>
              ...
              <div className='bg-black border-2 border-[#C74200] p-5 flex flex-col items-center mt-5'>
                <div className='text-white flex flex-col lg:flex-row gap-5 items-center text-lg lg:text-2xl mb-8'>
                  <div className='flex py-8 pr-5 md:mt-8  border-b-2 lg:border-b-0 lg:border-r-2 border-[#C74200]   gap-2 md:flex-col'>
                ...
                <div className='text-white flex items-center gap-2 text-lg lg:text-2xl'>
